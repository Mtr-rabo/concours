...
export class DepotComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.depotService
      ...
      .subscribe(
        (res: HttpResponse<IDepot[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDepots(): void {
    this.eventSubscriber = this.eventManager.subscribe('depotListModification', () => this.loadPage());
  }
